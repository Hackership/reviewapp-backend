...
Revision ID: 2de387271331
Revises: None
Create Date: 2015-03-11 17:10:54.351715

"""

# revision identifiers, used by Alembic.
revision = '2de387271331'
down_revision = None
...
def upgrade():
    ...
    sa.Column('stage', sa.Enum('incoming', 'in_review', 'email_send', 'reply_received', 'skyped', 'accepted', 'rejected', 'grant_review', 'grant_accepted', 'grant_rejected', 'archived', 'inactive'), nullable=True),
